...
if __name__ == "__main__":
    ...
    run_model, value_policy_model = make_models(in_t, out_t, n_actions, entropy_beta=0.5)
    ...
    value_policy_model.compile(optimizer=Adam(lr=0.00001, clipnorm=0.1), loss=loss_dict)
    ...
    players = [
        Player(make_env(args.env, args.monitor, wrappers=env_wrappers), reward_steps=20, gamma=0.999,
